...
type JobsJSONItem struct {
	...
	Jobcat2     *int64
	Jobcat3     *int64
	Edu         *int64 // 最高學歷(用二進位儲存)(1: 高中以下 2:高中4:專科 8:大學16碩士 32:博士)
	SalaryLow   *int64
	SalaryHigh  *int64
	...
	MajorCat1   *int64 `json:"major_cat"` // 相關科系類別
	MajorCat2   *int64
	MajorCat3   *int64
	Industry    *int64
	Vacation    *string `json:"worktime"`
	RoleStatus  *int64  // 1:上班族 2:應屆畢 4:日間部 8:夜間部 16:尋找國防役 32:外籍人士 64:原住民 128:接受人力派遺-派遺單位專用 256:二度就業-派遺單位專用 512:soho
	...
	NeedEmpLow  *int64 `json:"needemp"`  // 最低需求人數
	NeedEmpHigh *int64 `json:"needemp2"` // 最高需求人數
	StartBy     *int64 // 上班日期：0:一週內 1:兩週 2:一個月 3:不限 4:可年後上班
	ExpJobCat1  *int64 // 相關職務經驗
	ExpJobCat2  *int64
	ExpJobCat3  *int64
